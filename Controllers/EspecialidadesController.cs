...
namespace AgendaDelConsultorio.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        {
            ViewData["TipoEspecialidadId"] = new SelectList(_context.TiposEspecialidades, "TipoEspecialidadId", "TipoEspecialidadId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EspecialidadId,Descripcion,Precio,Duracion,Observacion,TipoEspecialidadId")] Especialidad especialidad)
        {
            ...
            ViewData["TipoEspecialidadId"] = new SelectList(_context.TiposEspecialidades, "TipoEspecialidadId", "TipoEspecialidadId", especialidad.TipoEspecialidadId);
            return View(especialidad);
        }
